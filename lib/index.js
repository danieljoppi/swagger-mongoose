...
var propertyMap = function (property) {
  switch (property.type) {
    ...
    case 'object':
      var object = property;
      return {
        $ref: getSchema('', object['properties'] ? object['properties'] : object)
      };
    default:
...
var processRef = function (property, objectName, props, key, required) {
  ...
  if (propType !== objectName) {
    ...
    if (~['array', 'object'].indexOf(object.type)
      || object.allOf && object.allOf.filter(function(o) {
        return ~['array', 'object'].indexOf(o.type);
      })
    ) {
 ...
 *
 * @param spec {String|Object}
 * @param [_extraDefinitions] {Object}
 * @returns {{schemas: Object, models: Object}}
 */
